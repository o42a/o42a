...
public final class MainFn extends Fn<MainFn> {

	public static final Signature MAIN = new Signature();

	private MainFn(FuncCaller<MainFn> caller) {
		super(caller);
	}
	...
	public static final class Signature
			extends org.o42a.codegen.code.Signature<MainFn> {
		...
		@Override
		public MainFn op(FuncCaller<MainFn> caller) {
			return new MainFn(caller);
		}
