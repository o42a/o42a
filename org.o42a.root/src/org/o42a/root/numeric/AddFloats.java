...
@SourcePath(relativeTo = Root.class, value = "floats/add.o42a")
public final class AddFloats extends BinaryFloat {

	public AddFloats(MemberOwner owner, AnnotatedSources sources) {
