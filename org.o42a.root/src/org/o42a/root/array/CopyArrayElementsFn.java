...
public final class CopyArrayElementsFn extends Fn<CopyArrayElementsFn> {

	public static final
	ExtSignature<BoolOp, CopyArrayElementsFn> COPY_ARRAY_ELEMENTS =
			...
			.returnBool(c -> new CopyArrayElementsFn(c));

	private static final ID COPIED = ID.rawId("copied");

	private CopyArrayElementsFn(FuncCaller<CopyArrayElementsFn> caller) {
		super(caller);
	}
