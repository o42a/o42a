...
public abstract class CodePtr<F extends Func> extends AbstractPtr {
	...
	static final class NullPtr<F extends Func> extends CodePtr<F> {

		NullPtr(Signature<F> signature, CodeAllocation<F> allocation) {
	...
	static final class FuncPtr<F extends Func> extends CodePtr<F> {

		private final Function<F> function;

		FuncPtr(Function<F> function, CodeAllocation<F> allocation) {
	...
	static final class ExternPtr<F extends Func> extends CodePtr<F> {
