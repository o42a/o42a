...
final class DebugDumpFn extends Fn<DebugDumpFn> {

	public static final ExtSignature<Void, DebugDumpFn> DEBUG_DUMP =
			customSignature(DEBUG_ID.sub("DumpF"), 3)
			.addPtr("prefix")
			.addData("data")
			.addInt32("depth")
			.returnVoid(c -> new DebugDumpFn(c));

	private DebugDumpFn(FuncCaller<DebugDumpFn> caller) {
		super(caller);
	}
