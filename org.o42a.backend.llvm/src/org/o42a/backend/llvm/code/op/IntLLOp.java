...
public abstract class IntLLOp<O extends IntOp<O>, T extends O>
	...
	public T add(ID id, Code code, O summand) {
		...
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId =
				code.opNames().binaryId(id, ADD_ID, summand, this);
	...
	public T sub(ID id, Code code, O subtrahend) {
		...
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId =
				code.opNames().binaryId(id, SUB_ID, subtrahend, this);
	...
	public T mul(ID id, Code code, O multiplier) {
		...
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId =
				code.opNames().binaryId(id, MUL_ID, multiplier, this);
	...
	public T div(ID id, Code code, O divisor) {
		...
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId =
				code.opNames().binaryId(id, DIV_ID, divisor, this);
	...
	public T rem(ID id, Code code, O divisor) {
		...
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId =
				code.opNames().binaryId(id, REM_ID, divisor, this);
	...
	public BoolLLOp eq(ID id, Code code, O other) {
		...
		final long nextPtr = llvm.nextPtr();
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId = code.opNames().binaryId(id, EQ_ID, other, this);
	...
	public BoolLLOp ne(ID id, Code code, O other) {
		...
		final long nextPtr = llvm.nextPtr();
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId = code.opNames().binaryId(id, NE_ID, other, this);
	...
	public BoolLLOp gt(ID id, Code code, O other) {
		...
		final long nextPtr = llvm.nextPtr();
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId = code.opNames().binaryId(id, GT_ID, other, this);
	...
	public BoolLLOp ge(ID id, Code code, O other) {
		...
		final long nextPtr = llvm.nextPtr();
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId = code.opNames().binaryId(id, GE_ID, other, this);
	...
	public BoolLLOp lt(ID id, Code code, O other) {
		...
		final long nextPtr = llvm.nextPtr();
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId = code.opNames().binaryId(id, LT_ID, other, this);
	...
	public BoolLLOp le(ID id, Code code, O other) {
		...
		final long nextPtr = llvm.nextPtr();
		final NativeBuffer ids = llvm.getModule().ids();
		final ID resultId = code.opNames().binaryId(id, LE_ID, other, this);
