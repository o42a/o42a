...
final class RelDataAlloc extends SimpleDataAllocation<DataOp<RelOp>> {
	...
	@Override
	protected DataOp<RelOp> op(long blockPtr, long nativePtr) {
		return new LLVMDataOp.Rel(blockPtr, nativePtr);
	}
