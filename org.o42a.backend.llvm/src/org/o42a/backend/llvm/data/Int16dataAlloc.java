...
final class Int16dataAlloc extends SimpleDataAllocation<Int16recOp> {
	...
	@Override
	protected LLVMRecOp.Int16 op(
			CodeId id,
			AllocClass allocClass,
			long blockPtr,
			long nativePtr) {
		return new LLVMRecOp.Int16(id, allocClass, blockPtr, nativePtr);
	}
