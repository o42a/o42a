...
void o42a_fld_var_propagate(o42a_ctable_t *const ctable) {
	O42A_ENTER;

	const o42a_var_fld *const from = &ctable->from.fld->var;
	o42a_var_fld *const to = &ctable->to.fld->var;
...
void o42a_fld_var_inherit(o42a_ctable_t *const ctable) {
	O42A_ENTER;
	...
	if (overrider) {// Field is overridden.
		if (!o42a_ascendant_of_type(
			...
			const o42a_var_fld *const ovr = &o42a_overrider_fld(overrider)->var;
