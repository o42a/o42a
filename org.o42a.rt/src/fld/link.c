...
void o42a_fld_link_propagate(o42a_ctable_t *const ctable) {
	O42A_ENTER;

	const o42a_link_fld *const from = &ctable->from.fld->link;
	o42a_link_fld *const to = &ctable->to.fld->link;
...
void o42a_fld_link_inherit(o42a_ctable_t *const ctable) {
	O42A_ENTER;
	...
	if (overrider) {// Field is overridden.
		if (!o42a_ascendant_of_type(
			...
			to->constructor = o42a_overrider_fld(overrider)->link.constructor;
			O42A_RETURN;
		}
	}
