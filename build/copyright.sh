...
assign_copyright org.o42a.lib.macros/src "Standard Macros" "*.java"
assign_copyright org.o42a.lib.macros/o42a "Standard Macros" "*.o42a"
...
assign_copyright org.o42a.tools/src "Build Tools" "*.java"
assign_copyright org.o42a.util/src "Utilities" "*.java"
assign_copyright runtime/include "Run-Time Library" "*.h"
assign_copyright runtime/src "Run-Time Library" "*.c"
assign_copyright runtime/test "Run-Time Library Tests" "*.c"
assign_copyright tests/o42a "Tests" "*.o42a"
