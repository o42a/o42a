...
assign_copyright GPL-o42a org.o42a.intrinsic/o42a "Intrinsics" "*.o42a"
assign_copyright GPL      org.o42a.lib.collections/src "Collections Library" "*.java"
assign_copyright GPL-o42a org.o42a.lib.collections/o42a "Collections Library" "*.o42a"
assign_copyright GPL      org.o42a.lib.console/src "Console Module" "*.java"
assign_copyright GPL-o42a org.o42a.lib.console/o42a "Console Module" "*.o42a"
assign_copyright GPL      org.o42a.lib.macros/src "Standard Macros" "*.java"
assign_copyright GPL-o42a org.o42a.lib.macros/o42a "Standard Macros" "*.o42a"
assign_copyright GPL      org.o42a.lib.test/src "Test Framework" "*.java"
assign_copyright GPL-o42a org.o42a.lib.test/o42a "Test Framework" "*.o42a"
...
assign_copyright GPL      runtime/include "Run-Time Library" "*.h"
assign_copyright GPL      runtime/src "Run-Time Library" "*.c"
