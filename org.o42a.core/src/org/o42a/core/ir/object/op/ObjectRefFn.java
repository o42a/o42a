...
public final class ObjectRefFn extends ObjectFn<ObjectRefFn> {

	public static final Signature OBJECT_REF = new Signature();

	ObjectRefFn(FuncCaller<ObjectRefFn> caller) {
		super(caller);
	}
	...
	public static final class Signature
			extends ObjectArgSignature<ObjectRefFn> {
		...
		@Override
		public ObjectRefFn op(FuncCaller<ObjectRefFn> caller) {
			return new ObjectRefFn(caller);
		}
