...
public class EagerRefNode extends AbstractRefNode {

	private final ExpressionNode owner;
	private final SignNode<Suffix> suffix;

	public EagerRefNode(ExpressionNode owner, SignNode<Suffix> suffix) {
	...
	public <R, P> R accept(RefNodeVisitor<R, P> visitor, P p) {
		return visitor.visitEagerRef(this, p);
	}
	...
	@Override
	public ScopeRefNode toScopeRef() {
		return null;
	}

	@Override
	public MemberRefNode toMemberRef() {
		return null;
	}

	@Override
	public AdapterRefNode toAdapterRef() {
		return null;
	}
